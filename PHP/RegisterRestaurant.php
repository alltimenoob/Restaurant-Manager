<?php
	...
	{
		$salt="qscefbthm";                         // Salt Value For Encryption
		$password=sha1($password,$salt);        // New Password After Encryption..
		
		$insert =  mysqli_query($con,"INSERT INTO `restaurant` VALUES(NULL,'$name','$email','$username','$password','$contact','$address','$gstin','$location','".addslashes($decoded)."')");
